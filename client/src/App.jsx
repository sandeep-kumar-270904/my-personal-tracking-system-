...
import SharedOffersPage from './pages/SharedOffersPage';
...
import OfflineBanner from './components/prephub/OfflineBanner';
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/shared/offers/:token" element={<SharedOffersPage />} />
          ...
          <Route element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
            ...
            <Route path="negotiation" element={<NegotiationSimulatorPage />} />
            ...
            <Route path="resources/collections/:id" element={<CollectionDetail />} />
            <Route path="settings" element={<SettingsPage />} />
            <Route path="my-stats" element={<MyStatsPage />} />
            <Route path="ai-analyzer" element={<AIAnalyzerPage />} />
            <Route path="journey" element={<JourneyPage />} />
            <Route path="network/student/:studentId" element={<StudentProfilePage />} />
