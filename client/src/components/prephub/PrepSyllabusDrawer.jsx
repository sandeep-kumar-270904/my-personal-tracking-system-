            ...
            <div>
              ...
              <div className="space-y-3">
                {syllabus.recommendedProblems?.map((prob, i) => (
                  <div key={i} className="bg-blue-500/5 border border-blue-500/10 hover:border-blue-500/30 hover:bg-blue-500/10 rounded-xl p-4 transition-colors group">
                    ...
                    <div className="flex gap-2 mt-3">
                      <a 
                        ...
                        className="flex-1 flex items-center justify-center gap-1 py-1.5 bg-blue-500/10 text-blue-400 rounded-lg text-xs font-bold hover:bg-blue-500/20 transition-colors"
                      >
                        <ExternalLink className="w-3.5 h-3.5" /> View
                      </a>
                      <button 
                        onClick={() => navigate(`/dsa?logProblem=true&title=${encodeURIComponent(prob.title)}`)}
                        className="flex-1 flex items-center justify-center gap-1 py-1.5 bg-[#ff6b00]/10 text-[#ff6b00] rounded-lg text-xs font-bold hover:bg-[#ff6b00]/20 transition-colors"
                      >
