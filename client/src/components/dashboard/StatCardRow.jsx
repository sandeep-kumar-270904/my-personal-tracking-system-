...
const StatCardRow = ({ stats }) => {
  const cards = [
    ...
    { title: 'Offers Received', value: stats?.offersReceived || 0, icon: CheckCircle2, color: 'text-emerald-500', bg: 'bg-emerald-500/20', border: 'border-emerald-500/50', link: '/offers' },
