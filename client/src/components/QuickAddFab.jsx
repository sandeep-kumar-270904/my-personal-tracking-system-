...
import { Plus, Briefcase, Code, Calendar, Users, X, BookOpen } from 'lucide-react';
...
const QuickAddFab = ({ onActionClick }) => {
  ...
  const actions = [
    ...
    { label: 'Study a Resource Today', id: 'STUDY_RESOURCE', icon: BookOpen, color: 'text-[#ff6b00]', bg: 'bg-[#ff6b00]/10' },
  ];

  const handleAction = (actionId) => {
    setIsOpen(false);
    if (actionId === 'STUDY_RESOURCE') {
      navigate('/resources');
