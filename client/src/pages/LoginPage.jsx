...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute top-1/4 -left-20 w-72 h-72 bg-blue-600/20 rounded-full blur-[100px] -z-10" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Log in to track your applications</p>
        </div>
