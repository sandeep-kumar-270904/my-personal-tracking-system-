              ...
              {contacts.map((contact) => (
                ...
                >
                  ...
                  <div className="mb-4 flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-[#13141f] flex items-center justify-center shrink-0 border border-white/10">
                      {getPlatformIcon(contact.platform)}
                    </div>
                    <div>
                      <h3 className="text-lg font-bold text-white mb-0.5 pr-12">{contact.name}</h3>
                      <p className="text-sm text-slate-400">{contact.role} @ <span className="text-[#00f0ff] font-medium">{contact.company}</span></p>
                    </div>
                  </div>
