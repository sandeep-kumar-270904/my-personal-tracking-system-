...
import ContestLeaderboardWidget from '../components/dashboard/ContestLeaderboardWidget';
...
import DashboardPrepWidget from '../components/dashboard/DashboardPrepWidget';
...
const DashboardPage = () => {
  ...
  const isBrandNew = stats.totalApplications === 0 && stats.dsaTopicsTracked === 0 && stats.activeInterviews === 0 && stats.networkingContacts === 0;
